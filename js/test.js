...
let products = [
   {
    id:1,
    name:' personal care', 
    image:'personalcare.webp ',
    price:379.000
   } ,
   {
    id:2,
    name:'boro plus doodh body lotion', 
    image:'boroplusdoodh bodylotion.webp',
    price:199.000
   },
   {
    id:3,
    name:'lemon grass hands wash', 
    image:'lemongrass handswash.webp',
    price:100.000
   },
   {
    id:4,
    name:'omega-3 frish oil', 
    image:'omega-3frishoil.webp',
    price:180.000
   }
   ,
   {
    ...
    image:'shikakai shampoo.webp',
    price:100.000
   },
   {
    id:6   ,
    name:'anti-bac wet wipes', 
    image:'anti-bac wet wipes.webp',
    price:160.000
   },
   {
   id:7,
   name:' appollo product', 
   image:'apollo_products.webp ',
   price:300.000
},
  {
   id:8,
